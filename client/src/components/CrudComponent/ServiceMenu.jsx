                    ...
                    <div className="collapse navbar-collapse " id="nav06">
                        <ul className="navbar-nav mx-auto mt-3 mt-lg-0 mb-3 mb-lg-0 ms-lg-3">
                            <span className="nav-item justify-content-center ms-4 d-flex">
                                <Link className="nav-link text-danger fw-bold  me-2" to="/dashboard/serviceCreate">Create Service</Link>
                                <Link className="nav-link text-muted me-2" to="/create">|</Link>
                                <Link className="nav-link text-danger fw-bold  me-2"
                                      to="/dashboard/serviceContentCrud">Service List</Link>
                            </span>
                        </ul>
                    </div>
                </div>
