    ...
    return (
        <div>
            <nav className="navbar sticky-top shadow-lg bg-white navbar-expand-lg navbar-light py-3">
                <Link className="nav-link text-white py-2 px-2 rounded-2 bg-dark ms-3 fw-bold  me-2" to="/dashboard"><i className="bi bi-door-open px-2"/>Go To Main Menu</Link>
                    ...
                    <div className="collapse navbar-collapse " id="nav06">
                        <ul className="navbar-nav mx-auto mt-3 mt-lg-0 mb-3 mb-lg-0 ms-lg-3">
                            <span className="nav-item justify-content-center ms-4 d-flex">
                                <Link className="nav-link text-danger fw-bold  me-2" to="/dashboard/blogCreate">Create Blog</Link>
                                <Link className="nav-link text-muted me-2" to="">|</Link>
                                <Link className="nav-link text-danger fw-bold  me-2" to="/dashboard/blogContentCrud">Blog List</Link>
                            </span>
                        </ul>
                    </div>
                </div>
